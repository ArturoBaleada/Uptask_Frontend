...
export default function ProjectTeamView() {
  ...
  if (data) return (
    <>
      ...
      <p className="text-2xl font-light text-gray-500 mt-5">Administrar el equipo de trabajo para este proyecto</p>

      <nav className="my-5 flex gap-3">
        <button onClick={() => navigate(location.pathname + '?addMember=true')} type="button" className="bg-purple-400 hover:bg-purple-500 px-10 py-3 text-white text-xl font-bold cursor-pointer transition-colors">
          Agregar Colaborador
        </button>
        <Link
